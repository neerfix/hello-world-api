 ...
 */
final class Version20220309222529 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE step DROP uuid, CHANGE travel_id travel_id VARCHAR(255) DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE place_id place_id VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE status status VARCHAR(255) DEFAULT NULL COLLATE `utf8_unicode_ci`');
