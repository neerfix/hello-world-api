 ...
 */
final class Version20220310084259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE step CHANGE travel_id travel_id INT DEFAULT NULL, CHANGE place_id place_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE step ADD CONSTRAINT FK_43B9FE3CECAB15B3 FOREIGN KEY (travel_id) REFERENCES travel (id)');
        $this->addSql('ALTER TABLE step ADD CONSTRAINT FK_43B9FE3CDA6A219 FOREIGN KEY (place_id) REFERENCES place (id)');
        $this->addSql('CREATE INDEX IDX_43B9FE3CECAB15B3 ON step (travel_id)');
        $this->addSql('CREATE INDEX IDX_43B9FE3CDA6A219 ON step (place_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE step DROP FOREIGN KEY FK_43B9FE3CDA6A219');
        $this->addSql('DROP INDEX IDX_43B9FE3CECAB15B3 ON step');
        $this->addSql('DROP INDEX IDX_43B9FE3CDA6A219 ON step');
        $this->addSql('ALTER TABLE step CHANGE travel_id travel_id VARCHAR(255) DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE place_id place_id VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE uuid uuid VARCHAR(180) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE status status VARCHAR(255) DEFAULT NULL COLLATE `utf8_unicode_ci`');
