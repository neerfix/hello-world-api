...
final class Version20220218083614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE file (id INT AUTO_INCREMENT NOT NULL, extension VARCHAR(255) NOT NULL, created_at DATE NOT NULL, updated_at DATE NOT NULL, user_id VARCHAR(255) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, mime_type VARCHAR(255) NOT NULL, size INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE following (main_user_id VARCHAR(180) NOT NULL, follower_id VARCHAR(180) NOT NULL, status VARCHAR(255) NOT NULL, created_at DATE NOT NULL, updated_at DATE NOT NULL, INDEX IDX_71BF8DE353257A7C (main_user_id), INDEX IDX_71BF8DE3AC24F853 (follower_id), PRIMARY KEY(main_user_id, follower_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE login (id INT AUTO_INCREMENT NOT NULL, user_id VARCHAR(180) DEFAULT NULL, application_version VARCHAR(255) NOT NULL, ip_address VARCHAR(255) NOT NULL, user_agent VARCHAR(255) NOT NULL, is_successful TINYINT(1) NOT NULL, failure_reason VARCHAR(255) NOT NULL, created_at DATE NOT NULL, updated_at DATE NOT NULL, INDEX IDX_AA08CB10A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE travel (id INT AUTO_INCREMENT NOT NULL, budget VARCHAR(255) NOT NULL, is_shared TINYINT(1) NOT NULL, description LONGTEXT NOT NULL, started_at DATE NOT NULL, ended_at DATE NOT NULL, user_id VARCHAR(255) DEFAULT NULL, created_at DATE NOT NULL, updated_at DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id VARCHAR(180) NOT NULL, uuid VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, firstname VARCHAR(50) DEFAULT NULL, lastname VARCHAR(70) DEFAULT NULL, username VARCHAR(55) NOT NULL, is_verify VARCHAR(180) NOT NULL, UNIQUE INDEX UNIQ_8D93D649D17F50A6 (uuid), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
